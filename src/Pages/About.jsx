...
import { FileText, Code, Award, Medal, Globe, ArrowUpRight, Sparkles, UserCheck } from "lucide-react"
import AOS from 'aos'
...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, totalBadges, YearExperience } = useMemo(() => {
    ...
    return {
      ...
      totalBadges: storedBadges.length,
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Think human. Code AI. Replace nothing — creating tools that amplify, not replace, human potential."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1N8398Rx0nrhwIHgejb7Yp_7plA0rpLQk/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
