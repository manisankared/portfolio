...
const WORDS = ["Software Engineer", "AI & Web Systems"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind CSS", "Python", "Java", "Git\ Github", "AWS", "Oracle", "Cloud Solutions"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/manisankared" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/manisankxr" },
  { icon: Instagram, link: "https://www.instagram.com/manishaxkar/" }
];
...
const Home = () => {
 ...
 const lottieOptions = {
  src: "https://lottie.host/2611be4a-aafe-4b65-93bd-ebca9537d1ae/H2DcgPLIXr.lottie",
  loop: true,
  autoplay: true,
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Engineering smart, scalable, and user-centric solutions with the power of modern AI and data-driven technologies.
                </p>
